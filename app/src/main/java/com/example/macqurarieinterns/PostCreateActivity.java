        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    udp   = "" + snapshot.child("P_imageURL").getValue();
                }
            }
            @Override
        ...
        switch (item.getItemId()){
            case R.id.add_post:
                ...
                if (TextUtils.isEmpty(description)){
                    Toast.makeText(PostCreateActivity.this, "Enter description...", Toast.LENGTH_SHORT).show();
                }
                if(image_rui == null){
                            ...
                            if (uriTask.isSuccessful()){
                                ...
                                ref.child(timestamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                pd.dismiss();
                                                Toast.makeText(PostCreateActivity.this, "Post published", Toast.LENGTH_SHORT).show();
                                                postDis.setText("");
                                                postImage.setImageURI(null);
                                                image_rui = null;
                                                 moveActivity(PostCreateActivity.this,MainActivity.class);
                                            }
                                        })
                                        .addOnFailureListener(new OnFailureListener() {
                                            @Override
